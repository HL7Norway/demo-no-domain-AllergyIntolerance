# 7514 Annen allergi som kritisk informasjon - Demo AllergyIntolerance Europa (EU Core/EHDS) og Norge v0.1.3
...
| | |
| :--- | :--- |
| *Official URL*:http://helsedir.no/fhir/CodeSystem/no-kodeverk-7514 | *Version*:0.1.3 |
